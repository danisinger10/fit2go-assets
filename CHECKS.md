...
- [x] Verified all primary and secondary CTAs point to https://www.fit2gopt.com/contact/ with GA4 event tracking via `.track-cta` listener.
- [x] Ensured contact modal is accessible via "Request a call back" link and submits fire GA4 `form_submit` events.
- [x] Embedded LocalBusiness, FAQPage, and Person JSON-LD with Rockville details.
- [x] Confirmed headshots (Ari Baylor and Dani Singer) load from provided URLs with descriptive Rockville-focused alt text, right-sized portrait framing (no cropping), and Rockville landmark references; lazy loading added to below-the-fold images.
